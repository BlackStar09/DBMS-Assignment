 ...
 */
public class AdminAddDept extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Department Addition");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminAddDept.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminAddDept().setVisible(true);
            }
        });
    }
